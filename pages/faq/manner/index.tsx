...
const Page: NextPage = () => {
  ...
  const categoryName = FAQ_CATEGORY.manner;
  const faqCategory = FAQ_CATEGORY_LIST.manner;
    ...
    <>
      ...
      <div id="page-faq-category">
        <main>
          ...
          <FaqQuestionList category="manner" />

          <OtherCategorySection hideTopBar currentCategory="manner" />
        </main>
      </div>
