            ...
            <div className="wrapper">
              <div className="answer-box slightly-colored-bg">
                ...
                <div className="answer">
                  <br />
                  <div className='mincho font-weight-bold font-size-24px'>{"通知状　[社葬]"}</div>
                  <div className='img'>
                    <img src="/images/faq/reference/d8_001.png?v=202206071620" alt="通知状　[社葬]" />
                  </div>
                  <br />

                  <div className='mincho font-weight-bold font-size-24px'>{"通知状　[お別れの会]"}</div>
                  <div className='img'>
                    <img src="/images/faq/reference/d8_002.png?v=202206071620" alt="通知状　[お別れの会]" />
                  </div>
                  <br />

                  <div className='mincho font-weight-bold font-size-24px'>{"通知状　[合同葬]"}</div>
                  <div className='img'>
                    <img src="/images/faq/reference/d8_003.png?v=202206071620" alt="通知状　[合同葬]" />
                  </div>
                </div>
              </div>
            </div>
