...
const Page: NextPage = () => {
  ...
  return (
    <>
      ...
      <div id="page-plan-syasou-premiumpack-1000m" className='page-plan-syasou-premiumpack-course'>
        <main>
            ...
            <div className="wrapper">
              ...
              <div className='content'>
                <div className='title'>
                  ...
                  <br></br>
                  <span className='price'>1,000</span><span>万円（1,100万円 税込）</span>
                </div>
                <div className='content-box'>
                  <div className='content-type'>
                    <div className='type-title'>2タイプより<br></br>お選びいただけます</div>
                    <div className='type-boxes vertical'>
                      <div className='type-box'>
                        <div className='type-name'>&lt;Type A&gt;</div>
                        <div className='type-image'>
                        <img src="/images/spc_1000_typea.jpg" alt="社葬プレミアムパック1000万円typeA" className="op noscale" />
                        <img src="/images/spc_1000_typea_sp.jpg" alt="社葬プレミアムパック1000万円typeA" className="os noscale" />
                        </div>
                        <div className='type-size'>（サイズ ： 幅 11.7×高さ 3.3×奥行 2.4m）</div>
                      </div>
                      <div className='type-box'>
                        <div className='type-name'>&lt;Type B&gt;</div>
                        <div className='type-image'>
                        <img src="/images/spc_1000_typeb.jpg" alt="社葬プレミアムパック1000万円typeB" className="op noscale" />
                        <img src="/images/spc_1000_typeb_sp.jpg" alt="社葬プレミアムパック1000万円typeB" className="os noscale" />
                        </div>
                        <div className='type-size'>（サイズ ： 幅 11.7×高さ 3.3×奥行 2.4m）</div>
                      </div>
                    </div>
                    ...
                    <div className='plan-content-section'>
                      <div className='plan-item plan-big-item'>
                        <div className='plan-item-image'>
                          <img src="/images/spc_01_iei.png" alt="遺影" />
                        </div>
                        <div>
                          <div className='plan-item-title'>遺影</div>
                          <div className='plan-item-content'>カラー電照額A0サイズ
                          <br></br>自宅用四切額・手札額
                      ...
                      <div className='plan-small-items'>
                        ...
                        <div className='plan-item'>
                          <div className='plan-item-image'>
                            <img src="/images/spc_1000_kanban1.png" alt="看板" />
                            <img src="/images/spc_06_kanban2.png" alt="看板" />
                          </div>
                          <div>
                            <div className='plan-item-title'>看板</div>
                            <div className='plan-item-content'>縦型浮文字大型看板(3.5m)
                            <br></br>または横型浮文字大型看板(3m)</div>
                          </div>
                        </div>
                        <br className='plan-item-3row'></br>
                        <br className='plan-item-6row'></br>
                      ...
                      <div className='plan-small-items'>
                        <div className='plan-item'>
                          ...
                          <div>
                            ...
                            <div className='plan-item-content'>60カット(1日分)</div>
                          </div>
                        </div>
                        <br className='plan-item-6row'></br>
                        <div className='plan-item'>
