...
const Page: NextPage = () => {
  ...
  return (
    <>
      ...
      <div id="page-plan-syasou-premiumpack-400m" className='page-plan-syasou-premiumpack-course'>
        <main>
            ...
            <div className="wrapper">
              ...
              <div className='content'>
                <div className='title'>
                  ...
                  <br></br>
                  <span className='price'>400</span><span>万円（440万円 税込）</span>
                </div>
                  ...
                  <div className='content-type'>
                    ...
                    <div className='type-boxes'>
                      <div className='type-box'>
                        ...
                        <img src="/images/spc_400_typea.jpg" alt="社葬プレミアムパック400万円typeA" />
                        </div>
                        <div className='type-size'>（サイズ ： 幅 6.3×高さ 2.7×奥行 1.8m）</div>
                      </div>
                      <div className='type-box'>
                        <div className='type-name'>&lt;Type B&gt;</div>
                        <div className='type-image'>
                        <img src="/images/spc_400_typeb.jpg" alt="社葬プレミアムパック400万円typeB" />
                        </div>
                        <div className='type-size'>（サイズ ： 幅 6.3×高さ 2.7×奥行 1.8m）</div>
                      </div>
                    </div>
