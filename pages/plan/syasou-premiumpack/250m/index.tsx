...
const Page: NextPage = () => {
  ...
  return (
    <>
      ...
      <div id="page-plan-syasou-premiumpack-250m" className='page-plan-syasou-premiumpack-course'>
        <main>
            ...
            <div className="wrapper">
              ...
              <div className='content'>
                <div className='title'>
                  ...
                  <br></br>
                  <span className='price'>250</span><span>万円（275万円 税込）</span>
                </div>
                  ...
                  <div className='content-type'>
                    ...
                    <div className='type-boxes'>
                      <div className='type-box'>
                        ...
                        <img src="/images/spc_250_typea.jpg" alt="社葬プレミアムパック250万円typeA" />
                        </div>
                        <div className='type-size'>（サイズ ： 幅 4.8×高さ 2.7×奥行 1.5m）</div>
                      </div>
                      <div className='type-box'>
                        <div className='type-name'>&lt;Type B&gt;</div>
                        <div className='type-image'>
                        <img src="/images/spc_250_typeb.jpg" alt="社葬プレミアムパック250万円typeB" />
                        </div>
                        <div className='type-size'>（サイズ ： 幅 4.8×高さ 2.7×奥行 1.5m）</div>
                      </div>
                    </div>
                    ...
                    <div className='plan-content-section'>
                      <div className='plan-item plan-big-item'>
                        <div className='plan-item-image'>
                          <img src="/images/spc_250_iei.png" alt="遺影" />
                        </div>
                        <div>
                          <div className='plan-item-title'>遺影</div>
                          <div className='plan-item-content'>カラー電照額全紙サイズ
                          <br></br>自宅用パール額・手札額
                          <br></br>(ホワイト・ピンク・スカイ・グレー・パープル・ネイビーよりお選びいただけます)</div>
                        </div>
                      </div>
                      <div className='plan-small-items'>
                        ...
                        <div className='plan-item'>
                          <div className='plan-item-image'>
                            <img src="/images/spc_400_kanban.png" alt="看板" />
                          </div>
                          <div>
                            <div className='plan-item-title'>看板</div>
                            <div className='plan-item-content'>縦型白木看板(3m)</div>
                          </div>
                        </div>
                        <br className='plan-item-3row'></br>
                        <br className='plan-item-6row'></br>
