...
const Page: NextPage = () => {
  ...
  return (
    <>
      ...
      <div id="page-plan-syasou-premiumpack-800m" className='page-plan-syasou-premiumpack-course'>
        <main>
            ...
            <div className="wrapper">
              ...
              <div className='content'>
                <div className='title'>
                  ...
                  <br></br>
                  <span className='price'>800</span><span>万円（880万円 税込）</span>
                </div>
                  ...
                  <div className='content-type'>
                    ...
                    <div className='type-boxes vertical'>
                      <div className='type-box'>
                        ...
                        <img src="/images/spc_800_typea.jpg" alt="社葬プレミアムパック800万円typeA" className="op noscale" />
                        <img src="/images/spc_800_typea_sp.jpg" alt="社葬プレミアムパック800万円typeA" className="os noscale" />
                        </div>
                        <div className='type-size'>（サイズ ： 幅 9.9×高さ 3×奥行 2.1m）</div>
                      </div>
                      <div className='type-box'>
                        <div className='type-name'>&lt;Type B&gt;</div>
                        <div className='type-image'>
                        <img src="/images/spc_800_typeb.jpg" alt="社葬プレミアムパック800万円typeB" className="op noscale" />
                        <img src="/images/spc_800_typeb_sp.jpg" alt="社葬プレミアムパック800万円typeB" className="os noscale" />
                        </div>
                        <div className='type-size'>（サイズ ： 幅 9.9×高さ 3×奥行 2.1m）</div>
                      </div>
                    </div>
                      ...
                      <div className='plan-small-items'>
                        ...
                        <div className='plan-item'>
                          ...
                          <div>
                            ...
                            <div className='plan-item-content'>縦型浮文字看板(3.2m)
