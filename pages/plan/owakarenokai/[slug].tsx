    ...
    <>
      ...
      <div id="page-plan-owakarenokai">
        <main>
          ...
          {slug === "jizenjunbi" && <modals.SyasouDialogJizenjunbi type="お別れの会" />}
          {slug === "goseikyo" && <modals.SyasouDialogGoseikyo type="お別れの会" />}
          {slug === "missou" && <modals.Missou type="owakarenokai" />}
