      ...
      <div id="page-beginner">
        <main>
          ...
          <div className="modalContents syasou opened">
            <modals.SyasouDialogJizenjunbi type="社葬" beginner />
            <modals.SyasouDialogGoseikyo type="社葬" beginner />
            <modals.Missou type="syasou" beginner />
          </div>
          <div className="modalContents owakarenokai">
            <modals.SyasouDialogJizenjunbi type="お別れの会" beginner />
            <modals.SyasouDialogGoseikyo type="お別れの会" beginner />
            <modals.Missou type="owakarenokai" beginner />
          </div>
          <div className="modalContents goudousou">
            <modals.SyasouDialogJizenjunbi type="合同葬" beginner />
            <modals.SyasouDialogGoseikyo type="合同葬" beginner />
